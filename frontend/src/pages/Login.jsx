    ...
    <div className="py-20">
      <div className="container-x max-w-md mx-auto">
        <div className="bg-white rounded-2xl shadow-card p-8">
          <h1 className="font-heading font-bold text-2xl text-navy mb-1 text-center">Welcome Back</h1>
          <p className="text-sm text-charcoal/60 text-center mb-7">Login to manage your bookings</p>
